...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    l1, c1 = affine_relu_forward(X, self.params['W1'], self.params['b1'])
    l2, c2 = affine_forward(l1, self.params['W2'], self.params['b2'])
    scores = l2
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    rc = 0.5
    loss += rc * self.reg * np.sum(self.params['W1'] * self.params['W1'])
    loss += rc * self.reg * np.sum(self.params['W2'] * self.params['W2'])

    dx2, grads['W2'], grads['b2'] = affine_backward(dx3, c2)
    dx1, grads['W1'], grads['b1'] = affine_relu_backward(dx2, c1)

    grads['W1'] += rc * 2 * self.reg * self.params['W1']
    grads['W2'] += rc * 2 * self.reg * self.params['W2']
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
